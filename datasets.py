...
def get_dataset(dataset_name, target_folder="./", datasets=DATASETS_CONFIG):
    ...
    if dataset_name == 'Houston13':
        ...
        label_values = ["dense urban febric", "mineral extraction sites", "non irrigated arable land", "fruit trees", "olive groves",
                        "coniferous forest", "dense sderophyllous vegetation", 'spare sderophyllous vegetation', 'sparcely vegatated areas', 'rocks and sand',
                        'water', 'coastal water']
